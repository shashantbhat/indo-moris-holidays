  ...
  toParameterizedQuery(e = { query: "", params: [] }) {
    ...
    for (let i = 0, s = t.length; i < s; i++) if (e.query += t[i], i < n.length) {
      ...
      if (o instanceof Ge) e.query += o.sql;
        ...
        if ((_a6 = o.queryData.params) == null ? void 0 : _a6.length) throw new Error("This query is not composable");
...
var kn = class kn2 extends wo.Client {
  ...
  connect(t) {
    ...
    let i = typeof this.config != "string" && ((_a6 = this.config) == null ? void 0 : _a6.host) !== void 0 || typeof this.config != "string" && ((_b5 = this.config) == null ? void 0 : _b5.connectionString) !== void 0 || m.env.PGHOST !== void 0, s = m.env.USER ?? m.env.USERNAME;
...
var Un = class Un2 extends go.Pool {
  ...
  query(t, n, i) {
    ...
    try {
      ...
      cs(l, { fullResults: true, arrayMode: t.rowMode === "array" }).query(f, y, { types: t.types ?? ((_a6 = this.options) == null ? void 0 : _a6.types) }).then((A) => i(void 0, A)).catch((A) => i(
        A
      ));
    } catch (o) {
      i(o);
