        ...
        <div className="min-h-screen bg-white p-6 text-black">
             <div id="target-section" className="max-w-4xl mx-auto">
                ...
                <div className="text-center mb-8">
                    <h1 className="text-4xl font-bold text-black mb-2">Travel Booking</h1>
                    <p className="text-gray-600">Plan your perfect journey with us</p>
                </div>

                {/* Success Message */}
                {showSuccess && (
                    <div className="mb-8 p-4 bg-green-50 border-l-4 border-green-400 text-green-800 rounded-r-lg shadow-sm flex items-center gap-3">
                ...
                <div className="bg-white border border-gray-200 rounded-xl shadow-lg p-8">
                    ...
                    >
                        ...
                        <label className="block text-lg font-semibold text-black">Trip Type</label>
                        ...
                        <label className="block text-lg font-semibold text-black">Travel Modes</label>
                        ...
                        <div className="bg-gray-50 p-6 rounded-lg">
                            <label className="flex items-center gap-3 cursor-pointer">
                                ...
                                <span className="text-lg font-semibold text-black"><CarStroke/> Need Cab Service?</span>
                            </label>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                <label className="block text-lg font-semibold mb-3 text-black">From City</label>
                                <input
                                    type="text"
                                    name="originCity"
                                    placeholder="Enter departure city"
                                    className="w-full border-2 border-gray-200 p-4 rounded-lg text-black placeholder-gray-500 focus:border-black focus:outline-none transition-colors"
                                />
                            </div>
                            <div>
                                <label className="block text-lg font-semibold mb-3 text-black">To City</label>
                                <input
                                    type="text"
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                <label className="block text-lg font-semibold mb-3 text-black">Departure Date</label>
                                <input
                                    type="date"
                                    name="departureDate"
                                    defaultValue={new Date().toISOString().split("T")[0]}
                                    className="w-full border-2 border-gray-200 p-4 rounded-lg text-black focus:border-black focus:outline-none transition-colors"
                                />
                            </div>
                            <div>
                                <label className="block text-lg font-semibold mb-3 text-black">Return Date</label>
                                <input
                                    type="date"
                                    name="returnDate"
                                    className="w-full border-2 border-gray-200 p-4 rounded-lg text-black focus:border-black focus:outline-none transition-colors"
                        ...
                        <h3 className="text-lg font-semibold mb-4 text-black">Passengers & Class</h3>
                        ...
                        <label className="block text-lg font-semibold mb-4 text-black">Fare Category</label>
                        ...
                        <div className="text-center pt-6">
                            <button
                                ...
                                className={`px-4 py-2 rounded-2xl font-medium text-white text-lg shadow-lg transition-all transform hover:scale-105 ${
                                    showSuccess
